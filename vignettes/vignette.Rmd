...
```{r heatmap_with_numbers_asymmetric, fig.width=8, fig.height=6, out.width="100%", dpi=150, fig.cap="Overlap percentage heatmap with values displayed in each cell"}
...
```{r heatmap_clean_asymmetric, fig.width=8, fig.height=6, out.width="100%", dpi=150, fig.cap="Co-occurrence heatmap without numbers for better visual clarity"}
plot_pubmatrix_heatmap(result,
...
```{r bar_plots_asymmetric, out.width="100%", dpi=150}
# Create data frame for List A genes (rows) colored by List B genes (columns)
...
```{r heatmap_with_numbers_asymmetric2, fig.width=8, fig.height=6, out.width="100%", dpi=150, fig.cap="Overlap percentage heatmap with values displayed in each cell"}
plot_pubmatrix_heatmap(result,
...
```{r heatmap_clean_asymmetric2, fig.width=8, fig.height=6, out.width="100%", dpi=150, fig.cap="Co-occurrence heatmap without numbers for better visual clarity"}
plot_pubmatrix_heatmap(result,
