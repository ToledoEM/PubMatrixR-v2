...
```{r heatmap_with_numbers_asymmetric, dpi=150, fig.cap="Overlap percentage heatmap with values displayed in each cell"}
...
```{r heatmap_clean_asymmetric, dpi=150, fig.cap="Co-occurrence heatmap without numbers for better visual clarity"}
plot_pubmatrix_heatmap(result, 
...
```{r heatmap_with_numbers_asymmetric2, out.width="100%", dpi=150, fig.cap="Overlap percentage heatmap with values displayed in each cell"}
plot_pubmatrix_heatmap(result, 
...
```{r heatmap_clean_asymmetric2, out.width="100%", dpi=150, fig.cap="Co-occurrence heatmap without numbers for better visual clarity"}
plot_pubmatrix_heatmap(result, 
